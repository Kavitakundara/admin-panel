...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($password !== $cpassword) {
        ...
        if ($checkQuery->num_rows > 0) {
            ...
            $insertQuery->bind_param("ssssssssss", $name, $username, $hashedPassword, $address, $phn, $gst, $documentNames, $documentTypes, $user_role, $created_by);
                ...
                <form id="ManagerRegistration" class="form_c" method="POST" enctype="multipart/form-data" action="">
                    <div class="user__details">
                        ...
                        <div class="input__box">
                            ...
                            <input name="phone" id="contact" placeholder="9999XXXXXX">
                        </div>
                        <div class="input__box">
                        ...
                        <div class="input__box">
                            ...
                            <input type="text" name="created_by" id="gst" placeholder="Enter Admin Name">
                        </div>
                    </div>

                    <div class="btn-css">
                        <button type="submit" id="regi-btn" class="button">Register</button>
                        <button type="button" id="login-btn" class="button">
